#!/usr/bin/env python3
"""
Improved lighting control panel with sliders for position controls.
...
class ImprovedLightingControlPanel(QDockWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.setObjectName("ImprovedLightingControlPanel")
...
if __name__ == "__main__":
    """Test the improved lighting control panel."""
    import sys
    from PySide6.QtWidgets import QApplication
    
    app = QApplication(sys.argv)
    
    panel = ImprovedLightingControlPanel()
    panel.show()
    
    # Test signal connections
    def on_position_changed(x, y, z):
        print(f"Position changed: X={x:.0f}, Y={y:.0f}, Z={z:.0f}")
    
    def on_color_changed(r, g, b):
        print(f"Color changed: R={r:.2f}, G={g:.2f}, B={b:.2f}")
    
    def on_intensity_changed(intensity):
        print(f"Intensity changed: {intensity:.2f}")
    
    panel.position_changed.connect(on_position_changed)
    panel.color_changed.connect(on_color_changed)
