...
def setup_development():
    ...
    if not run_command("pip install -r requirements.txt -r requirements-dev.txt", "Installing dependencies"):
        return False
...
def main():
    """Main function."""
    parser = argparse.ArgumentParser(description='Easy build helper for Digital Workshop')
