...
class ProjectDetailsController:
    ...
    def setup_project_details_dock(self) -> None:
        ...
        try:
            self.main_window.properties_dock = QDockWidget("Project Details", self.main_window)
            ...
            self.main_window.project_details_widget = ProjectDetailsWidget(self.main_window)
            self.main_window.properties_dock.setWidget(self.main_window.project_details_widget)
            ...
            try:
                ...
                self.logger.debug("Failed to register Project Details dock for snapping: %s", e)
