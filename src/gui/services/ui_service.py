...
from PySide6.QtWidgets import (
    QApplication, QMessageBox, QProgressBar, QLabel, QPushButton,
    QVBoxLayout, QHBoxLayout, QWidget, QFrame, QGraphicsDropShadowEffect
)
...
class NotificationWidget(QWidget):
    ...
    def _apply_styling(self) -> None:
        ...
        color = type_colors.get(NotificationType(self.notification.type), type_colors[NotificationType.INFO])
...
class ViewerUIService(IViewerUIService):
    ...
    def _show_notification(self, title: str, message: str, notification_type: NotificationType) -> None:
        ...
        try:
            ...
            if notification.auto_hide:
                QTimer.singleShot(notification.duration_ms, lambda: self._remove_notification(notification.id))
