    ...
    def _apply_theme_sync(self, theme_name: str) -> bool:
        ...
        try:
            ...
            if success:
                ...
                self.ui_service.show_info("Theme Applied", f"Theme '{theme_name}' has been applied successfully.")
    ...
    def get_theme_preview(self, theme_name: str) -> Optional[str]:
        ...
        try:
            ...
            preview_info = {
                ...
                "colors": list(theme_data.get("colors", {}).keys()) if theme_data.get("colors") else [],
                "components": list(theme_data.get("components", {}).keys()) if theme_data.get("components") else [],
...
Components ({len(preview_info['components'])}): {', '.join(preview_info['components'][:5])}{'...' if len(preview_info['components']) > 5 else ''}
    ...
    def validate_theme(self, theme_name: str) -> Tuple[bool, str]:
        ...
        try:
            ...
            if is_valid:
                ...
                self.theme_cache[theme_name] = {"validated": True, "data": self._load_theme_data(theme_name)}
    ...
    def preview_theme_temporarily(self, theme_name: str, duration_ms: int = 3000) -> bool:
        ...
        try:
            ...
            if not is_valid:
                self.ui_service.show_warning("Invalid Theme", f"Cannot preview theme: {error_message}")
                return False
            ...
            if success:
                ...
                self.ui_service.show_info("Theme Preview", 
    ...
    def revert_to_previous_theme(self) -> bool:
        ...
        try:
            ...
            if success:
                self.ui_service.show_info("Theme Reverted", f"Reverted to theme: {self.previous_theme}")
    ...
    def _on_validation_completed(self, theme_name: str, is_valid: bool, error_message: str) -> None:
        ...
        try:
            ...
            if is_valid:
                ...
                theme_data = self._load_theme_data(theme_name)
                if theme_data:
                    self.theme_cache[theme_name] = {"validated": True, "data": theme_data}
