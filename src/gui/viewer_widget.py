"""
PyQt3D viewer widget for 3D-MM application.

This module provides a 3D visualization widget using PyQt3D with Qt3DWindow,
QOrbitCameraController for mouse interaction, and configurable lighting.
"""
