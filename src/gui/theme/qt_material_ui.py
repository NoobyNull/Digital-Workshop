...
class QtMaterialColorPicker(QDialog):
    ...
    def _create_material_colors_tab(self) -> None:
        ...
        for color_hex, color_name in colors:
            ...
            color_button.clicked.connect(
                lambda checked, c=color_hex: self._select_color(c)
            )
    ...
    def _create_custom_color_tab(self) -> None:
        ...
        custom_color_display.setStyleSheet(
            f"background-color: {self.current_color}; border: 1px solid #ccc;"
        )
    ...
    def _select_color(self, color_hex: str) -> None:
        ...
        self.custom_color_display.setStyleSheet(
            f"background-color: {color_hex}; border: 1px solid #ccc;"
        )
...
class QtMaterialThemeDialog(QDialog):
    ...
    def _create_color_customization_tab(self) -> None:
        ...
        for i, color_name in enumerate(color_names):
            ...
            color_button.clicked.connect(
                lambda checked, name=color_name: self._pick_custom_color(name)
            )
    ...
    def _pick_custom_color(self, color_name: str) -> None:
        ...
        if picker.exec() == QDialog.Accepted:
            color = picker.get_selected_color()
            self.custom_colors[color_name].setStyleSheet(
...
def create_color_picker(
    parent=None, current_color: str = "#1976D2"
