...
class VTKColorProvider(QObject):
        ...
        try:
            ...
            for vtk_manager in self._vtk_managers:
                try:
                    ...
                    logger.warning(f"Failed to update VTK manager {vtk_manager.__class__.__name__}: {e}")
    ...
    def _update_vtk_color_cache(self) -> None:
        ...
        common_colors = [
            ...
            "grid_color", "ground_color", "model_surface", "light_color",
            "text", "border", "selection", "success", "warning", "error"
        ]
