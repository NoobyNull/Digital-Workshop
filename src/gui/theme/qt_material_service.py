...
class QtMaterialThemeService(QObject):
    ...
    def __init__(self):
        ...
        logger.info(
            "QtMaterialThemeService initialized with qt-material-only architecture"
        )
    ...
    def _apply_qt_material_theme(self, theme: str, variant: str = None) -> None:
        ...
        try:
            ...
            if app:
                ...
                logger.warning(
                    "No QApplication instance available for qt-material theme"
                )
    ...
    def cycle_variant(self) -> bool:
        ...
        # Find next variant
        current_index = (
            variants.index(current_variant) if current_variant in variants else 0
        )
