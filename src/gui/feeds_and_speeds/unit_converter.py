...
class UnitConverter:
    ...
    def convert_feed_rates(feed_data: Dict, to_metric: bool) -> Dict:
        ...
        feed_keys = ['v_f', 'v_f_leadIn', 'v_f_leadOut', 'v_f_plunge', 'v_f_ramp', 'v_f_transition']
    ...
    @staticmethod
    def format_value(value: float, is_metric: bool, unit_type: str = 'length', decimals: int = 3) -> str:
        """
