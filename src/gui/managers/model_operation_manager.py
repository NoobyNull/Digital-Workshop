...
class ModelOperationManager:
    ...
    def on_model_loaded(self, info: str) -> None:
        ...
        try:
            self.main_window.activity_logger.info("Model loaded: %s", info)
    ...
    def edit_model(self, model_id: Optional[int] = None) -> None:
        try:
            ...
            self.logger.info("Editing model %s", model_id)
    ...
    def import_models(self) -> None:
        ...
        try:
            ...
            self.logger.error("Failed to import models: %s", e)
    ...
    def _restore_saved_camera(self, model_id: int) -> None:
        ...
        try:
            ...
            self.logger.debug("Failed to restore saved camera: %s", e)

    def _refresh_recent_panel(self) -> None:
        """Refresh the MRU panel if available."""
