...
from PySide6.QtWidgets import (
    ...
    QComboBox, QProgressBar, QGroupBox, QFormLayout, QLineEdit, QSpinBox,
...
class AIDescriptionWidget(QWidget):
    ...
    def _apply_to_metadata(self):
        ...
        result_data = {
            ...
            "keywords": [self.keywords_result.item(i).text() for i in range(self.keywords_result.count())]
        }
        ...
        QMessageBox.information(
            self,
            "Applied",
            "AI description has been applied to the model metadata."
        )
