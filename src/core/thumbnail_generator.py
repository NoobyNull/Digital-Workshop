"""
Thumbnail Generator for 3D Model Previews

This module generates 1080x1080 PNG thumbnails for 3D models using VTK offscreen rendering.
Supports customizable backgrounds (solid colors or images) and hash-based file naming.
"""
...
from core.data_structures import Model
