...
class ServiceCleanupHandler(CleanupHandler):
    ...
    def _cleanup_bootstrap_services(self) -> bool:
        ...
        try:
            ...
            if self._application and hasattr(self._application, 'bootstrap') and self._application.bootstrap:
                try:
        ...
        try:
            ...
            for thread in threading.enumerate():
                try:
                    ...
                    self.logger.warning(f"Failed to cleanup thread {getattr(thread, 'name', 'unknown')}: {e}")
