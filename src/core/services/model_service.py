...
from src.core.interfaces.parser_interfaces import IParser, IFormatDetector, ParseError, FileNotSupportedError
            ...
            if model_id in self._progress_callbacks:
                try:
                    ...
                    self._logger.warning(
                        "Error in progress callback for model %s: %s",
                        model_id,
                        error
                    )
