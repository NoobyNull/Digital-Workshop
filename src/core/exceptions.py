...
class ParsingException(CandyCadenceException):
    ...
    def __init__(
        ...
        context = {"file_path": file_path, "format_type": format_type, **kwargs}
...
class DatabaseException(CandyCadenceException):
    ...
    def __init__(
        ...
        context = {"operation": operation, "table_name": table_name, **kwargs}
...
class ValidationException(CandyCadenceException):
    ...
    def __init__(
        ...
        context = {"field_name": field_name, "value": value, **kwargs}
...
class MemoryException(CandyCadenceException):
    ...
    def __init__(
        ...
        context = {"operation": operation, "memory_usage": memory_usage, **kwargs}
...
class ConfigurationException(CandyCadenceException):
    ...
    def __init__(
        ...
        context = {"config_key": config_key, "config_source": config_source, **kwargs}
...
class UIException(CandyCadenceException):
    ...
    def __init__(self, message: str, ui_component: str = None, **kwargs):
        ...
        context = {"ui_component": ui_component, **kwargs}
