...
class FileIOErrorHandler(SpecificErrorHandler):
    ...
    def __init__(self, operation: str, file_path: Optional[Path] = None, 
                 context_info: Optional[Dict[str, Any]] = None):
        super().__init__(
            context=ErrorContext.FILE_LOADING if "load" in operation.lower() else ErrorContext.FILE_SAVING,
...
@contextmanager
def handle_file_io_errors(operation: str, file_path: Optional[Path] = None,
                          context_info: Optional[Dict[str, Any]] = None):
    """
...
def specific_error_handler(context: ErrorContext,
                          expected_errors: Optional[Union[Type[Exception], tuple]] = None,
                          recovery_strategy: Optional[ErrorRecoveryStrategy] = None,
                          context_info: Optional[Dict[str, Any]] = None,
                          reraise: bool = True):
