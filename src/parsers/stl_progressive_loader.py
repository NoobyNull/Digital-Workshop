...
from src.parsers.base_parser import (
    Model, ModelFormat, Vector3D, ModelStats, ProgressCallback, LoadingState
)
...
class LODConfig:
    ...
    def __post_init__(self):
        if self.levels is None:
            self.levels = [LODLevel.ULTRA_LOW, LODLevel.LOW, LODLevel.MEDIUM, LODLevel.HIGH, LODLevel.FULL]
...
class ProgressiveSTLLoader:
    ...
    def __init__(self, config: Optional[LODConfig] = None, gpu_config: Optional[GPUParseConfig] = None):
