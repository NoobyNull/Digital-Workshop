...
class RefactoredOBJParser(RefactoredBaseParser):
    ...
    def __init__(self):
        ...
        super().__init__(
            parser_name="OBJ",
            supported_formats=[ModelFormat.OBJ]
        )
    ...
    def _parse_obj_file(
        ...
        List[OBJVertex], List[Tuple[float, float, float]], List[Tuple[float, float]],
        ...
        with open(file_path, 'r', encoding='utf-8', errors='ignore') as file:
            ...
            for i, line in enumerate(lines):
                ...
                if progress_callback and i % 1000 == 0:
                    ...
                    self._update_progress(progress, f"Parsed {i}/{line_count} lines", progress_callback)
        ...
        with open(file_path, 'r', encoding='utf-8', errors='ignore') as file:
            ...
            for line in file:
                ...
                if processed_lines % 5000 == 0:
                    ...
                    self._update_progress(progress, f"Processed {processed_lines}/{line_count} lines", progress_callback)
    ...
    def _validate_geometry_internal(self, file_path: Path) -> Dict[str, Any]:
        ...
        try:
            ...
            with open(file_path, 'r', encoding='utf-8', errors='ignore') as file:
                ...
                if 'mtllib' in content and not any(line.strip().lower().startswith('mtllib') for line in file.readlines()):
    ...
    def _get_model_info_internal(self, file_path: Path) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'complexity': 'high' if face_count > 10000 else 'medium' if face_count > 1000 else 'low'
            }
