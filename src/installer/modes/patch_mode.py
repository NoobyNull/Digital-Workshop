...
class PatchMode:
    ...
    def execute(self, version: str, modules: List[str]) -> bool:
        ...
        try:
            ...
            logger.info(f"Current version: {current_version}, patching to: {version}")
