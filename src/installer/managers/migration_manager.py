...
class MigrationManager:
    ...
    def apply_migrations(self, from_version: str, to_version: str) -> bool:
        ...
        try:
            ...
            logger.info(f"Migration path: {migrations}")
            ...
            logger.info(f"Migrations applied: {from_version} -> {to_version}")
            return True
    ...
    def _apply_migration(self, cursor, migration_name: str):
        ...
        logger.debug(f"Migration {migration_name} applied")
    
    def _get_migration_path(self, from_version: str, to_version: str) -> List[str]:
        """Get list of migrations to apply."""
        logger.debug(f"Getting migration path: {from_version} -> {to_version}")
    ...
    def _record_migration(self, cursor, version: str, migration_type: str):
        ...
        logger.debug(f"Recording migration: {version} ({migration_type})")
    ...
    def get_migration_history(self) -> List[Dict]:
        ...
        try:
            ...
            logger.debug(f"Found {len(history)} migration records")
            return history
