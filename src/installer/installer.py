...
class Installer:
    ...
    def detect_installation(self) -> Optional[Dict]:
        ...
        try:
            ...
            logger.info(f"Existing installation found: v{version}")
            logger.info(f"Installed modules: {installation_info['installed_modules']}")
            
            return installation_info
            
        except Exception as e:
            logger.error(f"Error detecting installation: {e}")
            return None
    ...
    def _update_version_file(self, version: str):
        ...
        try:
            ...
            logger.debug(f"Version file updated: {version}")
        except Exception as e:
    ...
    def install(self, mode: str, version: str, modules: List[str] = None):
        ...
        logger.info(f"Starting {mode} installation (v{version})")
        logger.info(f"Modules to install: {modules}")
        ...
        try:
            ...
            logger.info(f"{mode} installation completed successfully")
