...
if exist "unified_test_runner.py" (
    move "unified_test_runner.py" "tests\runner.py" >nul 2>&1
    if !errorlevel! equ 0 (
...
if exist "pyinstaller.spec" (
    move "pyinstaller.spec" "config\" >nul 2>&1
    if !errorlevel! equ 0 (
...
if exist "code_quality_validator.py" (
    move "code_quality_validator.py" "tools\quality\" >nul 2>&1
    if !errorlevel! equ 0 (
...
if exist "naming_validator.py" (
    move "naming_validator.py" "tools\quality\" >nul 2>&1
    if !errorlevel! equ 0 (
...
if exist "quality_gate_enforcer.py" (
    move "quality_gate_enforcer.py" "tools\quality\" >nul 2>&1
    if !errorlevel! equ 0 (
...
if exist "monolithic_detector.py" (
    move "monolithic_detector.py" "tools\analysis\" >nul 2>&1
    if !errorlevel! equ 0 (
