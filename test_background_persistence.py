...
def test_background_persistence():
    ...
    brick_path = Path(__file__).parent / "src" / "resources" / "backgrounds" / "Brick.png"
    ...
    bg_image_from_settings = settings.value("thumbnail/background_image", config.thumbnail_bg_image, type=str)
    bg_color = settings.value("thumbnail/background_color", config.thumbnail_bg_color, type=str)
