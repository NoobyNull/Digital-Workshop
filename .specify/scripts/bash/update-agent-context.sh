...
#    - Supports various AI coding assistants with generic reference handling
#    - Can update single assistants or all existing assistant files
#    - Creates generic assistant file if no assistant files exist
#
