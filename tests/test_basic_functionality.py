...
def test_model_loading():
    ...
    if stl_file.exists():
        try:
            ...
            print(
                f"[OK] STL file loaded successfully: {model.stats.triangle_count} triangles"
            )
    ...
    if obj_file.exists():
        try:
            ...
            print(
                f"[OK] OBJ file loaded successfully: {model.stats.triangle_count} triangles"
            )
        except Exception as e:
    ...
    if threemf_file.exists():
        try:
            ...
            print(
                f"[OK] 3MF file loaded successfully: {model.stats.triangle_count} triangles"
            )
        except Exception as e:
...
def test_performance_monitoring():
    ...
    try:
        ...
        print(
            f"   - Monitoring active: {report.get('monitoring_status', {}).get('active', False)}"
        )
