"""
Comprehensive Performance Testing Framework for Candy-Cadence

This module provides automated performance testing for all critical components
...
from src.parsers.refactored_step_parser import STEPParser
...
"""
    ...
    def run_all_tests(self):
        ...
        print("=" * 60)
        print("CANDY-CADENCE COMPREHENSIVE PERFORMANCE TESTING")
        print("=" * 60)
...
def main():
    ...
    with PerformanceTestFramework() as framework:
        ...
        if report.summary['failed_tests'] == 0:
            ...
            print(f"\n⚠️  {report.summary['failed_tests']} performance test(s) FAILED!")
            return 1
