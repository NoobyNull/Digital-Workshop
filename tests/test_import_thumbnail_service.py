...
class TestImportThumbnailService(unittest.TestCase):
    ...
    def test_generate_thumbnail_success(self, mock_generator_class):
        ...
        def create_thumbnail(*args, **kwargs):
            ...
            return expected_thumbnail_path, None
    ...
    def test_generate_thumbnail_force_regenerate(self, mock_generator_class):
        ...
        mock_generator.generate_thumbnail.return_value = (thumbnail_path, None)
    ...
    def test_register_existing_thumbnail(self, mock_resizer_class):
        ...
        model_path = self.test_storage_path / "external_model.stl"
        thumbnail_path = self.test_storage_path / "external_thumb.png"
        model_path.write_bytes(b"model_data")
        thumbnail_path.write_bytes(b"thumbnail_data")

        result = service.register_existing_thumbnail(
