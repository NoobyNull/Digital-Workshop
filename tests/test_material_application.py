...
class TestMaterialApplication(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with open(self.test_mtl_path, "w") as f:
            f.write(
                f"""newmtl {self.test_material_name}
Ka 0.2 0.2 0.2
Kd 0.8 0.6 0.4
Ks 0.1 0.1 0.1
Ns 10.0
...
"""
    ...
    def test_material_provider_discovers_materials(self):
        ...
        with patch.object(
            MaterialProvider, "DEFAULT_MATERIALS_DIR", self.materials_dir
        ):
    ...
    def test_material_manager_apply_to_actor(self):
        ...
        with patch.object(
            ...
            result = material_manager.apply_material_to_actor(
                mock_actor, self.test_material_name
            )
