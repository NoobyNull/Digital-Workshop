...
def test_ai_service_has_current_provider():
    ...
    try:
        ...
        logger.info(f"✓ AI service has current_provider: {service.current_provider.__class__.__name__}")
...
def test_metadata_editor_can_get_ai_service():
    ...
    try:
        ...
        logger.info(f"✓ AI service has current_provider: {ai_service.current_provider.__class__.__name__}")
...
def main():
    ...
    logger.info("\n")
    logger.info("╔" + "=" * 68 + "╗")
    logger.info("║" + " " * 10 + "METADATA EDITOR AI ANALYSIS INTEGRATION TEST" + " " * 14 + "║")
    logger.info("╚" + "=" * 68 + "╝")
    ...
    results.append(("AI Service Has Current Provider", test_ai_service_has_current_provider()))
    results.append(("Metadata Editor Can Get AI Service", test_metadata_editor_can_get_ai_service()))
    results.append(("Metadata Editor Error Handling", test_metadata_editor_error_handling()))
