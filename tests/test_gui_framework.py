...
class GUITestBase(unittest.TestCase):
    ...
    def simulate_user_interaction(
        self, widget: QWidget, interaction_type: str, **kwargs
    ):
    ...
    def wait_for_condition(
        self, condition: Callable, timeout: int = 5000, interval: int = 100
    ):
    ...
    def measure_ui_responsiveness(
        self, widget: QWidget, operation: Callable
    ) -> Dict[str, float]:
