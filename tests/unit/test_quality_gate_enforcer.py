...
class TestQualityGateEnforcer(unittest.TestCase):
    ...
    def test_evaluate_quality_gates(self):
        ...
        code_quality_gate = next(
            g for g in gate_results if g.gate_name == "code_quality"
        )
        ...
        monolithic_gate = next(
            g for g in gate_results if g.gate_name == "monolithic_modules"
        )
...
class TestIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        test_config = {
            ...
            "reporting": {"formats": ["json", "console"]},
        }
