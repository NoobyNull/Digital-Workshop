...
class TestJSONFormatter:
    ...
    def test_format_with_exception(self):
        ...
        record.formatException.return_value = "Traceback (most recent call last):\nTest error"
...
""")
    ...
    def test_memory_usage_stability(self, runner):
        ...
        with patch('psutil.Process') as mock_psutil:
            ...
            mock_proc.memory_info.side_effect = [Mock(rss=mem * 1024 * 1024) for mem in memory_samples]
            mock_proc.cpu_percent.return_value = 25.0
            mock_psutil.return_value = mock_proc
            ...
            assert abs(result["max_memory_mb"] - 100.0) < 10.0  # Within 10MB of expected
